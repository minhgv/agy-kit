...
- Load the `qa-test-gen` skill to auto-generate unit and integration tests covering the 12-Dimensional Edge Case Matrix and mapped RTM requirements.
...
- Test 12-Dimensional edge cases and create Minimal Reproduction Examples (MRE) for any failures. Collect evidence into `tests/qa-evidence/`.
