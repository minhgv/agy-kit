...
```bash
// turbo
agy run --agent reviewer "Execute Quality Gate Audit using the 'qa-auditor' skill:
...
3. OWASP-AI CHECKLIST & TRACEABILITY:
...
4. AUDIT CONTRACT & RISK MATRIX: Generate JSON Audit Contract, evaluate Runtime Risk Matrix, verify RTM (Requirements Traceability Matrix) status, and audit 12-Dimensional Edge Case Matrix coverage.
